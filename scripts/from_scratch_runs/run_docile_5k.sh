...
IS_DOCILE=true
TRAIN_SUBSET_INDEX_PATH=data/docile/subsets_index/5k.json
VAL_SUBSET_INDEX_PATH=data/docile/list_data_train.json
LABEL_LIST_PATH=data/docile/label_list.json
