...
# LABEL_LIST = 
class RobertaTokenClassificationInternal(RobertaForTokenClassification):
    def __init__(self, config):
        super(RobertaForTokenClassificationInternal, self).__init__(config)
    ...
    def forward(
        ...
        # Calculate output embedding of roberta for whole sequence 
